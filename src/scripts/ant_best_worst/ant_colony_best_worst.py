...
def _mutate_pheromone_rows(
    ...
    """Apply documented search-scaled additive or subtractive row mutation."""
...
def ABW(
    ...
    *,
    ...
    """Find and retain the global-best route using Best-Worst Ant System.
    ...
    penalty_rate = (
        global_evap_rate if worst_penalty_rate is None else worst_penalty_rate
    )
    ...
    while epochs < max_epochs:
        ...
        for ant in range(ants_number):
            route, distance = ant_solution_best_worst(
                graph_map,
                pheromone_graph,
                start_node,
                end_node,
